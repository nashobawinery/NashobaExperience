...
export default function ExternalTrainingPage() {
  ...
  if (showLessonQuiz && hasLessonQuiz && currentLessonQuiz) {
    ...
    // Show result page if quiz was submitted but not passed
    ...
    // Show success page if quiz was passed
